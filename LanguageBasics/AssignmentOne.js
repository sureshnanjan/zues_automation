 ...
 * @param {} id Category Id should be a b
 ...
 * @param {} name Category name should be a String 
 * @param {} photoUrls Photo URLs should be a String
 * @param {} status Status should be a String
 */
...
/**
 * Display all types of pets in the store
 * @param {} id Category Id should be a Number
 * @param {} name Category name should be a String
 */
 ...
 * Display all types of pets in the store
 * @param {} id Category Id should be a number
 * @param {} petId Category name should be a number
 * @param {} quantity Quantity should be a number
 * @param {} shippedData
 * @param {} status Status should be a string
 * @param {} complete Complete should be a boolean
 * 
 */
 ...
 * Display all types of pets in the store
 * @param {} id Category Id should be a number
 * @param {} username Username should be a string
 * @param {} firstName First name should be a string
 * @param {} lastName Last name should be a string
 * @param {} email Email should be a string
 * @param {} password Password should be a string
 * @param {} phone Phone should be a number
 * @param {} userStatus User status should be a string
 * 
 */
