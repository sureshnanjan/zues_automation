...
constructor(page: Page) {
        ...
        this.TextFeild = page.locator('p',{hasText: 'You entered:'});
      ...
      async verifyKeyPressed():Promise<void> {
        await expect(this.TextFeild).toBeVisible();
      }
      /**
      ...
      async verifyTextField(key:string):Promise<void> {
        await expect(this.TextFeild).toHaveText('You entered: '+ key.toUpperCase());
      }
    }